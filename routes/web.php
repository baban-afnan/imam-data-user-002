...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('wallet')->group(function () {
            ...
            Route::post('/create', [WalletController::class, 'createWallet'])->name('wallet.create'); // Changed from create-virtual-account
    ...
    // Data Variation Management Routes
    Route::prefix('admin/data-variations')->name('admin.data-variations.')->middleware('auth')->group(function () {
